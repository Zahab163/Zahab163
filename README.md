...
-  **Digital Marketing Image Generator App** - This is an assistant for specially for digital marketers to generate Images like logo , header, banners ,etc for different social media platforms and prompt generator for using in gerating desirable images in Canva and similar apps.
